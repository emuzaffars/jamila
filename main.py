...
query = ''
token = "I3AlBDpE-3rImcW8rUVd-GiHCOIHYPpcsZxYzY3c"
...
def get_weather():
    city = 'Tashkent'
    API_KEY = "54fe9ad8a19b4a829c970818250901"
    ...
    try:
        ...
        weather_info_ru = f'Сегодня погода {weather_state_translations[overall_state][0]}, температура {temperature:.1f}'
...
phrases = {
	...
	"wiki_search_fail": ['Unfortunately, nothing was found from Wikipedia. Try to search something else', 'К сожалению, из Википедии ничего не нашлось, попробуйте поискать что-то другое', 
                      'Afsuski, Vikipediadan hech narsa topilmadi, iltimos boshqa narsa qidirib koring'],
	"wiki_specify": ['Try specifying what you mean and paraphrase your query', 'Постарайтесь задать вопрос по-конкретней или перефразируйте его', 
    ...
    'lang_error': ['Sorry, it is unrecognized language', 'Простите, язык не распознан'],
}
...
query_keywords = {
	...
	'change_lang_ru': ['измени язык', 'переключи язык', change_lang_ru],
	'change_lang_en': ['change language', 'switch language', change_lang_en],
	...
	'play': ['play the song', 'play song', 'play from browser', 'play from you tube', 'play from youtube', 'play music', 'play the music', 'start music', "turn on", 'включи',
          "включи музыку", 'qoshigini qoy', 'qoshigini top', 'ashulani top', 'qoshigini yutubdan qoy', 'qoshiqni youtube dan qoy', 'qoshiqni',
          'qoshiqni you tube dan qoy', 'qoshigini ijro et', 'qoshiqni ijro et',
          play_yt],
